        ...
        <div class="logo">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item active"><a href="{{url('agent')}}" class="nav-link">Agents</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <p class="breadcrumbs"><span class="mr-2"><a href="{{url('/')}}">Home</a></span> <span>Agents</span></p>
    		...
    		<div class="row">
    			...
    			@foreach($agent as $agents)
					<div class="col-md-6 col-lg-3 ftco-animate">
						<div class="staff">
							<div class="img" style="background-image: url(agentimage/{{$agents->image}});" style="height: 400px; width: 350px; !important"></div>
							<div class="text pt-4">
								<h3><a href="#">{{$agents->name}}</a></h3>
								<span class="position mb-2">{{$agents->phone}}</span>
								<p>{{$agents->email}}</p>
