    		...
    		<div class="row d-flex align-items-center">
    			<div class="col">
    				<p class="social d-flex">
    					<a href="https://www.facebook.com/profile.php?id=61560863990585"><span class="icon-facebook"></span></a>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4 ml-md-5">
              ...
              <ul class="list-unstyled">
                ...
                <li><a href="{{url('contact')}}" class="py-2 d-block">Recently Reduce</a></li>
                <li><a href="{{url('contact')}}" class="py-2 d-block">Off-Market Homes</a></li>
              </ul>
            </div>
          </div>
          <div class="col-md">
