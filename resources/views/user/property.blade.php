        ...
        <div class="logo">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item active"><a href="{{url('property')}}" class="nav-link">Property</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <p class="breadcrumbs"><span class="mr-2"><a href="{{url('/')}}">Home</a></span> <span>Property</span></p>
        ...
        <div class="row">
          ...
          <div class="col-md-4 ftco-animate">
            <div class="properties">
              <a href="property-single.html" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(propertyimage/{{$properties->image}});">
              </a>
              <div class="text p-3">
                <span class="status sale">{{$properties->status}}</span>
                <div class="d-flex">
                  <div class="one">
                    <h3><a href="property-single.html">{{$properties->location}}</a></h3>
                    <p>{{$properties->description}}</p>
                  </div>
                  <div class="two">
                    <span class="price">Kshs.{{$properties->price}}</span>
                  </div>
                </div>
                <p></p>
                <hr>
                <p class="bottom-area d-flex">
                  <span><i class="flaticon-selection"></i> {{$properties->size}}</span>
                </p>
              </div>
            </div>
          </div>
