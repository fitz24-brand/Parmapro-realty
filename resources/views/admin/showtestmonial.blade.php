          ...
          <div align="center" style="padding: 70px;">
            ...
            <table class="table_deg">
              ...
              <tr>
                ...
                <td style="padding:10px; color: white;">{{$testmonies->name}}</td>
                <td style="padding:10px; color: white;">{{$testmonies->caption}}</td>
                <td><img height="150" width="200" src="clientimage/{{$testmonies->image}}"></td>
                 <td><a onclick="return confirm('Are you sure you want to delete this?')" class="btn btn-danger" href="{{url('deletetestmony',$testmonies->id)}}">Delete</td>
              </tr>
              @endforeach
